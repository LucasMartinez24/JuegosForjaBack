...
async function main() {
  console.log(
    "🔒 Iniciando el reseteo con forzado de clave del Administrador Central...",
  );
  ...
  if (adminExistente) {
    ...
    console.log(
      "🔄 Cuenta existente encontrada. Contraseña reestablecida y bandera de cambio activada.",
    );
  } else {
    ...
    console.log(
      "✨ Perfil ADMIN creado desde cero con política de cambio obligatoria.",
    );
  }
  ...
  console.log(
    `🛡️  Política Activa: El sistema exigirá el cambio de clave al ingresar.`,
  );
  console.log("◈===========================================================◈");
